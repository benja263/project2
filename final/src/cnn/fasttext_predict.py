...
# uncomment if cbow
#SAVE_PATH = os.path.join(dir,'final_ft_model_cbow_dict.h5')
...
def main():
    ...
    with open('final_submission_fasttext_skipgram.csv', 'w') as csvfile:
    #if cbow
    #uncomment line below and comment line above
    #with open('final_submission_fasttext_cbow.csv', 'w') as csvfile:
